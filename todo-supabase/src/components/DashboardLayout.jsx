    ...
    return (
        <div className="flex flex-col md:flex-row h-screen bg-gray-100 relative overflow-hidden">
            ...
            ${isSidebarOpen ? "justify-start" : "justify-center"} bg-white text-sky-700 hover:bg-sky-50`}
                ...
                {/* Navigation */}
                <nav className="mt-6 px-2 flex-1 overflow-y-auto md:overflow-y-visible">
                    {[
            ...
            <div className="flex-1 flex flex-col min-h-0">
                {/* Top Navbar */}
                <header className="flex justify-between items-center bg-white shadow p-4 gap-4 flex-wrap pt-16 md:pt-4">
